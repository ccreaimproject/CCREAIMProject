...
>>>>>>> d004b19 (model saving to log folder)
...
>>>>>>> 6ed8c2f (Fix scheduler not working with logging.silent)
            scheduler.step()
            if not cfg.logging.silent:
                log.info(
...
>>>>>>> 2edd09b (Add exponential scheduler)
        if cfg.logging.checkpoint != 0 and epoch % cfg.logging.checkpoint == 0:
...
=======
            try:
                ...
                log.error(e)
>>>>>>> 9c54089 (add io exception handling)
